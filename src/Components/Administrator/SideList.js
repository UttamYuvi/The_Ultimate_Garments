...
<div style={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <List component="nav">
                    <React.Fragment>
                        ...
                        <Link to='/dashboard/displayallsize' style={{textDecoration:'none',color:'black'}}>
                        <ListItemButton>
                            <ListItemIcon>
                                <LayersIcon />
                            </ListItemIcon>
                        ...
                        <Link to='/dashboard/displayallcolor' style={{textDecoration:'none',color:'black'}}>
                        <ListItemButton>
                            <ListItemIcon>
                                <LayersIcon />
                            </ListItemIcon>
                        ...
                        <Link to='/dashboard/displayallbanner' style={{textDecoration:'none',color:'black'}} > 
                            <ListItemButton  >
                                <ListItemIcon>
                                    <ShoppingCartIcon />
                                </ListItemIcon>
